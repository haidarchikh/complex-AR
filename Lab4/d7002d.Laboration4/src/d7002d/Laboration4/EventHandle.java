...
/**
 * This class holds information about the simulation entity (e.g. a node, switch
 * or router) that triggered the event (like sending a message, timer event
 * etc.), the target (receiver of the event) and information in the event

...
/**
 * This class makes use of time stamps in milliseconds (or any granularity that
 * you like to use). In the case that two events are scheduled for the same
 * time, the id of the entity are used to solve the conflict of who goes first.
 */

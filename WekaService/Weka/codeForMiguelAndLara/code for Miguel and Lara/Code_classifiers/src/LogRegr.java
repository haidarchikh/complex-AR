...
public class LogRegr {

	static final String fname = "C:\\Andrey\\Tools\\Weka-3-7\\allResultLogRegr.bat";
	
	static final String cmdStart = "java -cp \"weka.jar\" ";
	
	static String classifier = "weka.classifiers.functions.Logistic";

	static String parameterList[] = {"R","M"};	
	
	static String parameters[][] = {{"1.0E-4","1.0E-5","1.0E-6","1.0E-7","1.0E-8",
		"1.0E-9","1.0E-10"},
		{"-1"}
		};
	...
	static String outputname = 
		"C:\\Users\\andboy\\Desktop\\ActRec\\LogRegrResults"+System.currentTimeMillis()+".csv";	

	static String logname = 
			"C:\\Users\\andboy\\Desktop\\ActRec\\LogRegrResults"+System.currentTimeMillis()+".log";	

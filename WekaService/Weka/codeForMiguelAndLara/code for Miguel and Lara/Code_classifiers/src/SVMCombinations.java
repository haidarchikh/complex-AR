...
public class SVMCombinations {

	static final String fname = "C:\\Andrey\\Tools\\Weka-3-7\\SVMcombinations.bat";
	
	static final String cmdStart = "java -cp \"weka.jar\" ";
	
	static String classifier = "weka.classifiers.functions.SMO";

	static String parameterList[] = {"C","L","P","N","V","W","K"};	
	
	static String parameters[][] = {{"100.0"},{"0.0010"},{"1.0E-12"},{"0"},{"-1"},{"1"},
	...
	static String outputname = 
		"C:\\Users\\andboy\\Desktop\\ActRec\\SVMCombinations"+System.currentTimeMillis()+".csv";	

	static String logname = 
			"C:\\Users\\andboy\\Desktop\\ActRec\\SVMCombinations"+System.currentTimeMillis()+".log";	
